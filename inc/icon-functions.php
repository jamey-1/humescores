	...
	if ( 'social' === $args->theme_location ) {
		foreach ( $social_icons as $attr => $value ) {
			if ( false !== strpos( $item_output, $attr ) ) {
				// $item_output = str_replace( $args->link_after, humescores_get_svg( array( 'icon' => esc_attr( $value ) ) ), $item_output );
				$item_output = str_replace( '</a>', humescores_get_svg( array( 'icon' => esc_attr( $value ) ) ) . '</a>', $item_output );
			}
		}
	}
